    ...
    def handle(self):
        ...
        options = " ".join(
            [
                ...
                f"--network='{network}'",
                f"--format='{format}'",
                f"--heating='{','.join(heating)}'" if heating else "",
                f"--cooling='{','.join(cooling)}'" if cooling else "",
                f"--shielding='{shieldingstr}'" if shieldingstr else "",
                f"--dust={dust}",
                f"--binding='{bindingstr}'" if bindingstr else "",
                f"--yield='{yieldstr}'" if yieldstr else "",
